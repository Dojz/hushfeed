...
* **TikTok:** Clear display, TikTok's own or the automatic one, no longer lifts the daily hold. It hides only TikTok's tab bar, and Hushfeed took that as you leaving the feed, so once the budget ran out the hold's panel came down and the sound came back. The panel now stays up over the whole screen. The same mistake hid Keep captions in clear display as soon as the controls cleared, and now the caption stays. The Block and Not interested buttons still go away with TikTok's controls.
