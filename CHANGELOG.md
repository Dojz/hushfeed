...
* **TikTok:** Hide comment popup ads now stops the brand animation itself. On 47.0.3 it only turned off TikTok's analytics report about the animation, so the animation still played. It was checked against TikTok's code and on a phone, but not with a real campaign, since none was running for our test account. Tell us if one still plays for you.
* **TikTok:** AMOLED dark theme now blackens the comment panel and the share sheet on 47.0.3. Both had stayed dark gray, because 47.0.3 paints them from a different color than 46.x did.
